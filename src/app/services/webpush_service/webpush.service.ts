...
export class WebPushService {
  ...
  send(notification: any) {
    ...
    return this.http.post(
      'https://api-fintrack.kbaenak.tech/fintrack-web-push-service/api/v1/webpush/send_notification',
      notification
    );
  ...
  sendToSpecificUser(notification: any, userId:string|null) {
    return this.http.post(
      'https://api-fintrack.kbaenak.tech/fintrack-web-push-service/api/v1/webpush/send_notification_user/' + userId,
      notification
    );
